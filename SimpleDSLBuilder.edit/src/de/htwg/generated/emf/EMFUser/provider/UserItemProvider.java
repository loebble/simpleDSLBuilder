/**
 */
package de.htwg.generated.emf.EMFUser.provider;


import de.htwg.generated.emf.EMFUser.EMFUserPackage;
import de.htwg.generated.emf.EMFUser.User;
...
/**
 * This is the item provider adapter for a {@link de.htwg.generated.emf.EMFUser.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFUserPackage.Literals.USER__FIRST_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFUserPackage.Literals.USER__LAST_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFUserPackage.Literals.USER__EMAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFUserPackage.Literals.USER__AGE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(User.class)) {
			case EMFUserPackage.USER__FIRST_NAME:
			case EMFUserPackage.USER__LAST_NAME:
			case EMFUserPackage.USER__EMAIL:
			case EMFUserPackage.USER__PHONE:
			case EMFUserPackage.USER__AGE:
	...
	public ResourceLocator getResourceLocator() {
		return UserEditPlugin.INSTANCE;
	}
