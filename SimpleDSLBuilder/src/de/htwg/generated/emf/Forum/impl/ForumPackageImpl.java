...
public class ForumPackageImpl extends EPackageImpl implements ForumPackage {
	 ...
	 * @see de.htwg.generated.emf.Forum.ForumPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link ForumPackage#eINSTANCE} when that field is accessed.
	...
	public static ForumPackage init() {
			...
			(theForumPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return ForumValidator.INSTANCE;
				 }
			 });
		...
		EPackage.Registry.INSTANCE.put(ForumPackage.eNS_URI, theForumPackage);
	 ...
	 * @generated
	 */
	public EOperation getUser__HasAddress__DiagnosticChain_Map() {
	...
	public void createPackageContents() {
		...
		createEOperation(userEClass, USER___HAS_ADDRESS__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getUser__HasAddress__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "hasAddress", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (addressEClass, 
		   source, 
		   new String[] {
			 "constraints", "NonNegativeValue ValidHouseNumber"
		   },
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Address/%Ecore%")
		   });
	}
