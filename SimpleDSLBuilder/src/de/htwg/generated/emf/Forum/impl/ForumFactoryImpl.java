...
public class ForumFactoryImpl extends EFactoryImpl implements ForumFactory {
	...
	public static ForumFactory init() {
		try {
			ForumFactory theForumFactory = (ForumFactory)EPackage.Registry.INSTANCE.getEFactory(ForumPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ForumPackage.USER: return createUser();
			case ForumPackage.ADDRESS: return createAddress();
			default:
