 ...
 * <ul>
 *   <li>{@link de.htwg.generated.emf.Forum.impl.AddressImpl#getStreet <em>Street</em>}</li>
 *   <li>{@link de.htwg.generated.emf.Forum.impl.AddressImpl#getHouseNumber <em>House Number</em>}</li>
 *   <li>{@link de.htwg.generated.emf.Forum.impl.AddressImpl#getZipCode <em>Zip Code</em>}</li>
 *   <li>{@link de.htwg.generated.emf.Forum.impl.AddressImpl#getAdditional <em>Additional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressImpl extends MinimalEObjectImpl.Container implements Address {
	...
	protected EClass eStaticClass() {
		return ForumPackage.Literals.ADDRESS;
	}
	...
	public void setStreet(String newStreet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForumPackage.ADDRESS__STREET, oldStreet, street));
	}
	...
	public void setHouseNumber(int newHouseNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForumPackage.ADDRESS__HOUSE_NUMBER, oldHouseNumber, houseNumber));
	}
	...
	public void setZipCode(int newZipCode) {
		...
		zipCode = newZipCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForumPackage.ADDRESS__ZIP_CODE, oldZipCode, zipCode));
	}
	...
	public void setAdditional(String newAdditional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForumPackage.ADDRESS__ADDITIONAL, oldAdditional, additional));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForumPackage.ADDRESS__STREET:
				return getStreet();
			case ForumPackage.ADDRESS__HOUSE_NUMBER:
				return getHouseNumber();
			case ForumPackage.ADDRESS__ZIP_CODE:
				return getZipCode();
			case ForumPackage.ADDRESS__ADDITIONAL:
