...
public class ForumExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ForumPackage.eNS_URI, 
			 ForumPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.forum"));
				User root = ForumFactory.eINSTANCE.createUser();
