 ...
 * <ul>
 *   <li>{@link de.htwg.generated.emf.user.UserModel.impl.AddressImpl#getStreet <em>Street</em>}</li>
 *   <li>{@link de.htwg.generated.emf.user.UserModel.impl.AddressImpl#getHouseNumber <em>House Number</em>}</li>
 *   <li>{@link de.htwg.generated.emf.user.UserModel.impl.AddressImpl#getZipCode <em>Zip Code</em>}</li>
 *   <li>{@link de.htwg.generated.emf.user.UserModel.impl.AddressImpl#getAdditional <em>Additional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressImpl extends MinimalEObjectImpl.Container implements Address {
	...
	protected EClass eStaticClass() {
		return UserPackage.Literals.ADDRESS;
	}
	...
	public void setStreet(String newStreet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.ADDRESS__STREET, oldStreet, street));
	}
	...
	public void setHouseNumber(int newHouseNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.ADDRESS__HOUSE_NUMBER, oldHouseNumber, houseNumber));
	}
	...
	public void setZipCode(int newZipCode) {
		...
		zipCode = newZipCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.ADDRESS__ZIP_CODE, oldZipCode, zipCode));
	}
	...
	public void setAdditional(String newAdditional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.ADDRESS__ADDITIONAL, oldAdditional, additional));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UserPackage.ADDRESS__STREET:
				return getStreet();
			case UserPackage.ADDRESS__HOUSE_NUMBER:
				return getHouseNumber();
			case UserPackage.ADDRESS__ZIP_CODE:
				return getZipCode();
			case UserPackage.ADDRESS__ADDITIONAL:
