...
public class ReflectBuildCreatorTest {

	public static void main(String[] args) {
//		ReflectBuilderCreator creator = ReflectBuilderCreator.getInstance("de.htwg.generated.emf.Forum.ForumFactory");
//		EMFBuilderModel builderModel = creator.getBuilderModel();
//		System.out.println(builderModel);
//		creator.printEclassWithMethods();
		ForumPackage forumPackage = ForumPackage.eINSTANCE;
//		EPackage ePackage = getEPackage("http://de.htwg.generated.Forum");
		EPackage eP = getEPackage(forumPackage);
		if(eP == null)
			System.out.println("Epackage = null");
		else printEPackage(eP);
	}
